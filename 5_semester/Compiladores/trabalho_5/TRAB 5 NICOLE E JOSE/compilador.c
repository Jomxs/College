...
{
       0,    73,    73,    78,    79,    89,    90,   100,   101,   110,
     111,   115,   116,   120,   121,   125,   132,   133,   134,   136,
     137,   138,   142,   143,   147,   148,   149,   155,   156,   160,
     161,   162,   163,   164,   165,   170,   171,   172,   176,   177,
     183,   184,   190,   194,   200,   210,   211,   222,   223,   224,
...
#line 1361 "compilador.c"
    break;

  case 3: /* Prog: Prog Function  */
#line 78 "semantic.y"
                     { /* TODO: Implementar - criar código e concatenar $1.code e $2.code */ }
#line 1367 "compilador.c"
    break;

  case 4: /* Prog: Function  */
#line 79 "semantic.y"
                   { (yyval.node) = (yyvsp[0].node); }
#line 1373 "compilador.c"
    break;

  case 5: /* Function: TypeF ID '(' ParamList ')' '{' Decls Statement_Seq '}'  */
#line 89 "semantic.y"
                                                                { for(int i=0; i<(yyvsp[-5].id_list).tam; i++){ Tabela[(yyvsp[-7].val)].arg_list[Tabela[(yyvsp[-7].val)].tam_arg_list++] = (yyvsp[-5].id_list).ids[i]; } offset = 0; set_type((yyvsp[-7].val), (yyvsp[-8].val)); set_num_param((yyvsp[-7].val), (yyvsp[-5].id_list).tam); /* TODO: Implementar - chamar Funct(&$$,$2,$8) */ }
#line 1379 "compilador.c"
    break;

  case 6: /* Function: TypeF ID '(' ')' '{' Decls Statement_Seq '}'  */
#line 90 "semantic.y"
                                                        { Tabela[(yyvsp[-6].val)].tam_arg_list = 0; offset = 0; set_type((yyvsp[-6].val), (yyvsp[-7].val)); set_num_param((yyvsp[-6].val), 0); /* TODO: Implementar - chamar Funct(&$$,$2,$7) */ }
#line 1385 "compilador.c"
    break;

  case 7: /* FunctionCall: ID '(' ArgList ')'  */
#line 100 "semantic.y"
                       { verifica_func_declarada((yyvsp[-3].val)); verifica_argumentos((yyvsp[-3].val), (yyvsp[-1].id_list).tam); /* TODO: Implementar - chamar Call(&$$,$1,$3) e atualizar $$.place */ }
#line 1391 "compilador.c"
    break;

  case 8: /* FunctionCall: ID '(' ')'  */
#line 101 "semantic.y"
                     { verifica_func_declarada((yyvsp[-2].val)); verifica_argumentos((yyvsp[-2].val), 0); /* TODO: Implementar - chamar Call_blank(&$$,$1) e atualizar $$.place */ }
#line 1397 "compilador.c"
    break;

  case 9: /* ArgList: Exp ',' ArgList  */
#line 110 "semantic.y"
                    { /* TODO: Implementar - concatenar código e armazenar places */ (yyval.id_list).tam = 0; for(int i=0; i<(yyvsp[0].id_list).tam; i++) {(yyval.id_list).ids[(yyval.id_list).tam++] = (yyvsp[0].id_list).ids[i];} (yyval.id_list).ids[(yyval.id_list).tam++] = (yyvsp[-2].node).place; }
#line 1403 "compilador.c"
    break;

  case 10: /* ArgList: Exp  */
#line 111 "semantic.y"
           { /* TODO: Implementar - criar código com $1.code */ (yyval.id_list).tam = 1; (yyval.id_list).ids[0] = (yyvsp[0].node).place; }
#line 1409 "compilador.c"
    break;
...
#line 1515 "compilador.c"
    break;

  case 34: /* Statement: FunctionCall ';'  */
#line 165 "semantic.y"
                           {(yyval.node) = (yyvsp[-1].node);}
#line 1521 "compilador.c"
    break;

  case 35: /* Statement: RETURN ID ';'  */
#line 170 "semantic.y"
                        { /* TODO: Implementar - carregar variável $2, mover para $v0 */ }
#line 1527 "compilador.c"
    break;

  case 36: /* Statement: RETURN NUM ';'  */
#line 171 "semantic.y"
                         { /* TODO: Implementar - carregar número $2.place, mover para $v0 */ }
#line 1533 "compilador.c"
    break;

  case 37: /* Statement: RETURN ';'  */
#line 172 "semantic.y"
                     { /* TODO: Implementar - criar código vazio (função void) */ }
#line 1539 "compilador.c"
    break;

  case 38: /* Compound_Stt: Statement  */
#line 176 "semantic.y"
                    {(yyval.node) = (yyvsp[0].node);}
#line 1545 "compilador.c"
    break;

  case 39: /* Compound_Stt: '{' Statement_Seq '}'  */
#line 177 "semantic.y"
                                {(yyval.node) = (yyvsp[-1].node);}
#line 1551 "compilador.c"
    break;

  case 40: /* If: IF '(' Exp ')' Compound_Stt ENDIF  */
#line 183 "semantic.y"
                                            { /* TODO: Implementar - chamar If(&$$,$3,$5) */ }
#line 1557 "compilador.c"
    break;

  case 41: /* If: IF '(' Exp ')' Compound_Stt ELSE Compound_Stt ENDIF  */
#line 184 "semantic.y"
                                                              { /* TODO: Implementar - chamar IfElse(&$$,$3,$5,$7) */ }
#line 1563 "compilador.c"
    break;

  case 42: /* While: WHILE '(' Exp ')' Compound_Stt  */
#line 190 "semantic.y"
                                        { /* TODO: Implementar - chamar While(&$$,$3,$5) */ }
#line 1569 "compilador.c"
    break;

  case 43: /* For: FOR '(' Atribuicao ',' Exp ',' Exp ')' Compound_Stt  */
#line 194 "semantic.y"
                                                            { }
#line 1575 "compilador.c"
    break;

  case 44: /* DoWhile: DO Compound_Stt WHILE '(' Exp ')' ';'  */
#line 200 "semantic.y"
                                              { /* TODO: Implementar - chamar DoWhile(&$$,$5,$2) */ }
#line 1581 "compilador.c"
    break;

  case 45: /* Atribuicao: ID '[' NUM ']' '=' Exp  */
#line 210 "semantic.y"
                                    { verifica_tipo_indice((yyvsp[-3].node).tipo); verifica_var_declarada((yyvsp[-5].val)); verifica_tipos_atrib(Tabela[(yyvsp[-5].val)].tipo, (yyvsp[0].node).tipo); (yyval.node).tipo = (yyvsp[0].node).tipo; (yyval.node).place = (yyvsp[-5].val); /* TODO: Implementar - chamar Atrib(&$$,$1,$6) */ }
#line 1587 "compilador.c"
    break;

  case 46: /* Atribuicao: ID '=' Exp  */
#line 211 "semantic.y"
                 { verifica_var_declarada((yyvsp[-2].val)); verifica_tipos_atrib(Tabela[(yyvsp[-2].val)].tipo, (yyvsp[0].node).tipo); (yyval.node).tipo = (yyvsp[0].node).tipo; (yyval.node).place = (yyvsp[-2].val); /* TODO: Implementar - chamar Atrib(&$$,$1,$3) */ }
#line 1593 "compilador.c"
    break;

  case 47: /* Exp: Exp '+' Exp  */
#line 222 "semantic.y"
                      {(yyval.node).tipo = retorna_maior_tipo((yyvsp[-2].node).tipo, (yyvsp[0].node).tipo); /* TODO: Implementar - chamar ExpAri("add",&$$,$1,$3) */ }
#line 1599 "compilador.c"
    break;

  case 48: /* Exp: Exp '-' Exp  */
#line 223 "semantic.y"
                      {(yyval.node).tipo = retorna_maior_tipo((yyvsp[-2].node).tipo, (yyvsp[0].node).tipo); /* TODO: Implementar - chamar ExpAri("sub",&$$,$1,$3) */ }
#line 1605 "compilador.c"
    break;

  case 49: /* Exp: Exp '*' Exp  */
#line 224 "semantic.y"
                      {(yyval.node).tipo = retorna_maior_tipo((yyvsp[-2].node).tipo, (yyvsp[0].node).tipo); /* TODO: Implementar - chamar ExpAri("mul",&$$,$1,$3) */ }
#line 1611 "compilador.c"
    break;

  case 50: /* Exp: Exp '/' Exp  */
#line 225 "semantic.y"
                      {(yyval.node).tipo = retorna_maior_tipo((yyvsp[-2].node).tipo, (yyvsp[0].node).tipo); /* TODO: Implementar - chamar ExpAri("div",&$$,$1,$3) */ }
#line 1617 "compilador.c"
    break;

  case 51: /* Exp: Exp '>' Exp  */
#line 226 "semantic.y"
                      {(yyval.node).tipo = INT; /* TODO: Implementar - chamar ExpRel("bgt",&$$,$1,$3) */ }
#line 1623 "compilador.c"
    break;

  case 52: /* Exp: Exp '<' Exp  */
#line 227 "semantic.y"
                      {(yyval.node).tipo = INT; /* TODO: Implementar - chamar ExpRel("blt",&$$,$1,$3) */ }
#line 1629 "compilador.c"
    break;

  case 53: /* Exp: Exp GE Exp  */
#line 228 "semantic.y"
                     {(yyval.node).tipo = INT;/* TODO: Implementar - chamar ExpRel("bge",&$$,$1,$3) */ }
#line 1635 "compilador.c"
    break;

  case 54: /* Exp: Exp LE Exp  */
#line 229 "semantic.y"
                     {(yyval.node).tipo = INT;/* TODO: Implementar - chamar ExpRel("ble",&$$,$1,$3) */ }
#line 1641 "compilador.c"
    break;

  case 55: /* Exp: Exp EQ Exp  */
#line 230 "semantic.y"
                     {(yyval.node).tipo = INT;/* TODO: Implementar - chamar ExpRel("beq",&$$,$1,$3) */ }
#line 1647 "compilador.c"
    break;

  case 56: /* Exp: Exp NEQ Exp  */
#line 231 "semantic.y"
                      {(yyval.node).tipo = INT;/* TODO: Implementar - chamar ExpRel("bne",&$$,$1,$3) */ }
#line 1653 "compilador.c"
    break;

  case 57: /* Exp: Exp OR Exp  */
#line 232 "semantic.y"
                     {(yyval.node).tipo = INT; /* TODO: Implementar - chamar ExpAri("or",&$$,$1,$3) */ }
#line 1659 "compilador.c"
    break;

  case 58: /* Exp: Exp AND Exp  */
#line 233 "semantic.y"
                      {(yyval.node).tipo = INT; /* TODO: Implementar - chamar ExpAri("and",&$$,$1,$3) */ }
#line 1665 "compilador.c"
    break;

  case 59: /* Exp: NOT Exp  */
#line 234 "semantic.y"
                  {(yyval.node).tipo = INT;}
#line 1671 "compilador.c"
    break;

  case 60: /* Exp: '(' Exp ')'  */
#line 235 "semantic.y"
                      {(yyval.node) = (yyvsp[-1].node);}
#line 1677 "compilador.c"
    break;

  case 61: /* Exp: NUM  */
#line 236 "semantic.y"
              {(yyval.node).tipo = INT; Li(&(yyval.node),(yyvsp[0].node).place); }
#line 1683 "compilador.c"
    break;

  case 62: /* Exp: NUM_REAL  */
#line 237 "semantic.y"
                   {(yyval.node).tipo = FLOAT; /* TODO: Implementar - chamar Li(&$$,$1.place) */ }
#line 1689 "compilador.c"
    break;

  case 63: /* Exp: ID '[' Exp ']'  */
#line 238 "semantic.y"
                         {verifica_var_declarada((yyvsp[-3].val)); (yyval.node).tipo = Tabela[(yyvsp[-3].val)].tipo; verifica_tipo_indice((yyvsp[-1].node).tipo); /* TODO: Implementar - chamar Lw(&$$,$1) */ }
#line 1695 "compilador.c"
    break;

  case 64: /* Exp: ID  */
#line 239 "semantic.y"
              {verifica_var_declarada((yyvsp[0].val)); (yyval.node).tipo = Tabela[(yyvsp[0].val)].tipo; /* TODO: Implementar - chamar Lw(&$$,$1) */ }
#line 1701 "compilador.c"
    break;

  case 65: /* Exp: CHARACTERE  */
#line 240 "semantic.y"
                     {(yyval.node).tipo = CHAR; /* TODO: Implementar - chamar Li(&$$,$1.place) */ }
#line 1707 "compilador.c"
    break;
...
#line 1713 "compilador.c"
    break;

  case 67: /* Exp: STRING  */
#line 242 "semantic.y"
                 {}
#line 1719 "compilador.c"
    break;


#line 1723 "compilador.c"
